...
public class Note {
    ...
    public Note(Eleve eleve, Matieres matiere, Double valeur, TypeEvaluation typeEvaluation) {
        this.eleve = eleve;
    ...
    public Matieres getMatiere() { return matiere; }
    public void setMatiere(Matieres matiere) { this.matiere = matiere; }
